...
from models.ULIP.data.dataset_3d import  *

from models.ULIP.models import losses
...
class ULIP_WITH_IMAGE(nn.Module):
    ...
    def encode_pc(self, pc):
        pc_feat, origin_pc = self.point_encoder(pc)
        pc_embed = pc_feat @ self.pc_projection
        return pc_embed, origin_pc
...
def ULIP_PointBERT(args):
    ...
    from models.ULIP.models.pointbert.point_encoder import PointTransformer
    config_addr = './models/ULIP/models/pointbert/PointTransformer_8192point.yaml'
